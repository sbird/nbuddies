...
parser.add_argument("--time", type = float, help="Total simulation time in seconds (default : 5e16)", default=5e17)
...
if args.do_binary:
    ...
    f"n_steps={args.n_steps}, adaptive_ts={args.adaptive_ts}, eta={args.eta}, use_tree={args.use_tree}")
